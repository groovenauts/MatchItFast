...
function NewsForm(props: Props) {
  ...
  return (
    <div className="NewsForm">
      ...
      <div className="NewsForm-subtitle">You can find the latest news articles from <a href="https://news.google.com/?hl=en-US" target="_blank" rel="noreferrer" style={{"color": "inherit"}} >Google News</a>.</div>
